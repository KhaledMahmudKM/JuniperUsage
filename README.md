# Juniper Usage Guide
## Basic Juniper OS (JunOS) Commands

## Ref:
1. [CLI User Guide for Junos OS
](https://www.juniper.net/documentation/us/en/software/junos/cli/cli.pdf)
1. [CLI Explorer](https://apps.juniper.net/cli-explorer/)
1. [OSPF User Guide](https://www.juniper.net/documentation/us/en/software/junos/ospf/topics/topic-map/configuring-ospf-areas.html)
...
1. [Useful JunOS Commands](#useful-commands)
...
Let's first show the configuration of R1 and R2 which are cisco routers.
...
### 3.1 JunOS: Hostname and Interface Configuration
...
![Alt text](ciscoroutingtable.png)

#### <u>BGP Table</u>

![Alt text](ciscobgptable.png)
...
![Alt text](junosroutingtable.png)
...
![Alt text](ciscoroutingtable_r1.png)


Test end-to-end connectivity

![Alt text](ciscoping_pc3.png)
